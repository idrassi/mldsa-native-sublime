...
#ifndef MLD_FIPS202_NATIVE_ARMV8_1_M_X4_V8M_MVE_H
#define MLD_FIPS202_NATIVE_ARMV8_1_M_X4_V8M_MVE_H

/* Part of backend API */
#define MLD_USE_FIPS202_X1_NATIVE
#define MLD_USE_FIPS202_X1_XOR_NATIVE
#define MLD_USE_FIPS202_X4_NATIVE
#define MLD_USE_FIPS202_X4_XOR_NATIVE
...
static MLD_INLINE void mld_keccakf1600_xor_bytes_native(
...
extern void KeccakF1600_StateExtractBytes(void *state,
                                          ...
                                          unsigned int offset,
                                          unsigned int length);
static MLD_INLINE void mld_keccakf1600_extract_bytes_native(
    uint64_t *state, const unsigned char *data, unsigned offset,
    unsigned length)
{
...
void KeccakF1600x4_StateXORBytes(void *state, const uint8_t *data0,
                                 ...
                                 uint32_t length);
static MLD_INLINE void mld_keccakf1600_xor_bytes_x4_native(
...
void KeccakF1600x4_StateExtract_bytes(void *state, unsigned char *data0,
                                      ...
                                      unsigned length);
static MLD_INLINE void mld_keccakf1600_extract_bytes_x4_native(
...
#endif /* !MLD_FIPS202_NATIVE_ARMV8_1_M_X4_V8M_MVE_H */
