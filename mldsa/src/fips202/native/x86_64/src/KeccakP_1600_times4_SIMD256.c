...
#define MLD_ROL64IN256_8(d, a) d = _mm256_shuffle_epi8(a, MLD_CONST256(rho8))
#define MLD_ROL64IN256_56(d, a) d = _mm256_shuffle_epi8(a, MLD_CONST256(rho56))
...
#define MLD_thetaRhoPiChiIotaPrepareTheta(i, A, E)                    \
  ...
  MLD_XOREQ256(E##ba, MLD_CONST256_64(keccakf1600RoundConstants[i])); \
  Ca = E##ba;                                                         \
