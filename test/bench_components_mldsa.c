...
static int bench(void)
{
  ...
  /* pointwise */
  BENCH("polyvecl_pointwise_acc_montgomery", mld_polyvecl_pointwise_acc_montgomery(&poly_out, &polyvecl_a, &polyvecl_b))
  BENCH("polyvec_matrix_pointwise_montgomery", mld_polyvec_matrix_pointwise_montgomery(&polyveck_out, polyvecl_mat, &polyvecl_b))
